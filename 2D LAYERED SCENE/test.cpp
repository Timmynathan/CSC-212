...
int main(int argc, char* argv[]) {
    ...
    backgroundTextures.push_back(loadTexture("./Assets/background_0.png"));
    backgroundTextures.push_back(loadTexture("./Assets/background_1.png"));
    backgroundTextures.push_back(loadTexture("./Assets/background_2.png"));
   backgroundTextures.push_back(loadTexture("./Assets/tileset.png"));
    

    // this is the way to do it individually
