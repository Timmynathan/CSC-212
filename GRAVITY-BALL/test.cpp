...
bool initSDL()
{
    ...
    // Create window
    gWindow = SDL_CreateWindow("Sail Ball", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
    if (gWindow == NULL) {
...
int main(int argc, char* argv[]) {
    ...
    SDL_Texture* ballTexture = loadTexture("./Assets/basketball.png"); // Load ball texture
    ...
    int ballSpriteWidth = 70;
    int ballSpriteHeight = 70;
    ...
    while (!quit) {
        ...
        SDL_Delay(15); // Adjust as needed for desired frame rate
    }
